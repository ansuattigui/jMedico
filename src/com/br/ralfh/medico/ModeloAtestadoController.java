 ...
 * @author ralfh
 */
public class ModeloAtestadoController extends Controller {
    
    private StatusBtn status;

    private ModeloAtestado modelo;
    private final SimpleObjectProperty<ModeloAtestado> sopModelo;
    private final ObservableList<ModeloAtestado> sopModelos;
    ...
    @FXML public MenuItem miNovoModelo;
    @FXML public MenuItem miEditaModelo;
    @FXML public MenuItem miExcluiModelo;
...
//    @FXML public MenuItem miSair;    
    ...
    @FXML public TableColumn<ModeloAtestado,String> modeloCol;
    ...
    public void setModelos() {
        this.sopModelos.setAll(ModelosAtestados.getLista());
    }
