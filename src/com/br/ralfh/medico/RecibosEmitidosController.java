 ...
 * @author ralfh
 */
public class RecibosEmitidosController extends Controller {
    ...
    public RecibosEmitidosController () {        
        tipoRelat = TipoRelatorio.recibosSintetico;        
    }    
    ...
    private boolean preparaRelatorio() {
        ...
        try {
            if (dataInicio.getValue()==null) {
                ...
                dDataIni = Util.udate(dataInicio.getValue());
            }
            if (dataFim.getValue()==null) {
                ...
                dDataFim = Util.udate(dataFim.getValue());
            }
    ...
    public void btnConfirmaFired(ActionEvent event) {
        switch (tipoRelat) {
            case recibosSintetico: {
                if (preparaRelatorio()) {
                    String fileName = "relatorios/recibos/RecibosSintetico.jasper";
